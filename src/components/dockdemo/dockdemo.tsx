...
export const DockDemo:FC=()=> {
    return (
        <>
            <Dock className="flex gap-x-2" iconMagnification={60} iconDistance={100}>
                <DockIcon >
                    <a href="https://www.linkedin.com/in/aleena-eldhose"
                        target="_blank">
                ...
                <DockIcon >
                    <a href="mailto:aleenaeldhose4021@gmail.com"
                        target="_blank">
